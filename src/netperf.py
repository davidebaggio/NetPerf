...
if __name__ == "__main__":
    ...
    s, s_b, t = calculation.calculate_throughput(
        steps, overall_performances, actual_hops)

    print(f"Throughput: {round(s, 2)} bits/s")
    print(f"Throughput Bottleneck: {round(s_b, 2)} bits/s")
    print(f"Time of propagation: {round(t*1000, 2)} ms")
